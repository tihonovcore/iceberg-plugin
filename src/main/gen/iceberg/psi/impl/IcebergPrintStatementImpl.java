...
public class IcebergPrintStatementImpl extends ASTWrapperPsiElement implements IcebergPrintStatement {

  public IcebergPrintStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
