...
public class IcebergClassIdentifierImpl extends ASTWrapperPsiElement implements IcebergClassIdentifier {

  public IcebergClassIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
