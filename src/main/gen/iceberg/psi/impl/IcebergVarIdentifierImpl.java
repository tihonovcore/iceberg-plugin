...
public class IcebergVarIdentifierImpl extends ASTWrapperPsiElement implements IcebergVarIdentifier {

  public IcebergVarIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
